...
var gameConfig={
  ...
  moveSpeed: 7,
  enemyMoveSpeed: Math.random(0.9, 2),

  // gravity and jump speed for all the characters
  gravity: Math.random(0.9, 2),
  gravityEnemy: Math.random(10),
  jump: -25,
...
gamestatus=""
 function play() {
   gamestatus="start";
   document.getElementById("IsLoaded").innerHTML="Status Game Is Loading";
 }
